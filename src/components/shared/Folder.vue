    ...
    <div class="flex flex-col">
        <div class="flex">
            <button class="text-black hover:text-white mr-5 w-1 focus:outline-none" @click="toggleExpanded">
                <fa :icon="['fas', 'chevron-down']" style="width: 1rem" v-if="isExpanded && !isEmpty" />
                <fa :icon="['fas', 'chevron-right']" style="width: 1rem" v-else-if="!isEmpty" />
            </button>
            <span><fa :icon="['fas', 'folder']" style="color: slategray"></fa></span>
